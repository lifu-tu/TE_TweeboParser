...
void DependencyFeatures::AddBaseTokenFeatures(int r, uint8_t fired, uint16_t bit_position){
  uint64_t fkey = encoder_.CreateFKey_W(DependencyFeatureTemplateArc::TWITTER_Token, fired, bit_position);
  AddFeature(fkey, input_features_[r]);
}
