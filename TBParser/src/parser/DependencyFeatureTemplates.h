...
struct DependencyFeatureTemplateArc {
  enum types {
    ...
    HP,           /* head POS */
    HB4,          /* head Brown Clustering 4 bit */
    HB6,          /* head Brown Clustering 6 bit */
    MP,           /* modifier POS [useless in unlabeled parsing] */
    MB4,          /* modifier Brown clustering 4 bits [useless in unlabeled parsing]*/
    MB6,          /* modifier Brown clustering 6 bits [useless in unlabeled parsing]*/
    HW,           /* head word */
    HBA,		  /* head brown clustering all bits */
    MW,           /* modifier word [useless in unlabeled parsing] */
    MBA,          /* modifier brown clustering all bits [useless in unlabeled parsing] */
    ...
    TWITTER_Token,    /* the token embedding model score feature for the parser */
    COUNT
  };
};
